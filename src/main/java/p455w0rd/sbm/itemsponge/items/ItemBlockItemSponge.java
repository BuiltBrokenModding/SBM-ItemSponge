package p455w0rd.sbm.itemsponge.items;
...
import p455w0rd.sbm.itemsponge.client.render.ItemLayerWrapper;
...
public class ItemBlockItemSponge extends ItemBlock {
	...
	public ItemBlockItemSponge() {
		super(ModBlocks.ITEM_SPONGE_BLOCK);
		setRegistryName(ModBlocks.ITEM_SPONGE_BLOCK.getRegistryName());
		setHasSubtypes(true);
	}
	...
	public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> items) {
		if (isInCreativeTab(tab)) {
			items.add(new ItemStack(ModItems.ITEM_SPONGE_ITEMBLOCK, 1, 0));
		}
	}
